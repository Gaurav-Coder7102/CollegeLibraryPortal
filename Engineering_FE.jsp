...
<div class="wrapper col3">
  ...
  <div id="templatemo_main">
     ...
     <td width="200" height="60" align="center"><font size="5" color="red">Mail ID</font></td>
     ...
     ResultSet rs = connection.createStatement().executeQuery("select * from upload_file where dpt='Engineering Science' and class_year='FE' order by id desc");
     while(rs.next())
     {
    	 %>
    	...
    	<td width="200" height="60" align="center"><font size="5" color="green"><%=rs.getString(5) %></font></td>
